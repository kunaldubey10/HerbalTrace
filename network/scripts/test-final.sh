...
if [[ $RESULT == *"COL001"* ]]; then
    echo -e "${GREEN}âœ“ Retrieved: Ashwagandha collection by Rajesh Kumar${NC}"
else
    echo -e "${RED}âœ— Failed to retrieve${NC}"
fi
...
if [[ $RESULT == *"QT001"* ]]; then
    echo -e "${GREEN}âœ“ Retrieved: Quality test passed by Dr. Sharma${NC}"
else
    echo -e "${RED}âœ— Failed to retrieve${NC}"
fi
...
if [[ $RESULT == *"PS001"* ]]; then
    echo -e "${GREEN}âœ“ Retrieved: Processing by Herbal Processing Ltd${NC}"
else
    echo -e "${RED}âœ— Failed to retrieve${NC}"
fi
...
if [ $? -eq 0 ]; then
    echo -e "${GREEN}âœ“ Product created with QR code${NC}"
else
    echo -e "${RED}âœ— Failed${NC}"
fi
...
if [[ $RESULT == *"PROD001"* ]]; then
    echo -e "${GREEN}âœ“ Retrieved: Premium Ashwagandha Powder${NC}"
...
if [[ $RESULT == *"Premium Ashwagandha"* ]]; then
    echo -e "${GREEN}âœ“ Product found by QR scan!${NC}"
else
    echo -e "${RED}âœ— QR lookup failed${NC}"
fi
...
echo ""
echo "=========================================="
echo -e "${GREEN}âœ“âœ“âœ“ COMPLETE E2E TEST PASSED âœ“âœ“âœ“${NC}"
echo "=========================================="
echo ""
echo "Supply Chain Flow Verified:"
echo "  1. âœ“ Farmer Collection (COL001) - Ashwagandha 100.5kg"
echo "  2. âœ“ Lab Quality Test (QT001) - Pass"
echo "  3. âœ“ Processor (PS001) - 85kg processed"
echo "  4. âœ“ Product (PROD001) - QR: QR-PROD001-2025"
echo "  5. âœ“ Consumer QR Scan - Working"
echo ""
